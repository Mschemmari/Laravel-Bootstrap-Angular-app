                    ...
                    @if (count($videos))
                        @foreach ($videos as $p)
                            <tr>
                                ...
                                <td>
                                    <a href="<?=route('admin.videos.get', ['id' => $p->id])?>">{{$p->title}}</a>
                                </td>
                                ...
                                <td width="15%">
                                    <div class="btn-group">
                                      <button type="button" class="btn btn-primary"><a href="<?=route('admin.videos.get', ['id' => $p->id])?>" style="color:#FFFFFF"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar</a></button>
                                      <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <span class="caret"></span>
                                      </button>
                                      <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?=route('admin.videos.delete', ['id' => $p->id])?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Borrar</a></li>
                                      </ul>
                                    </div>
                                </td>
                            </tr>
